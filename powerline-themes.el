...
;;;###autoload
(defun powerline-tspyimt-theme ()
  "Custom powerline for mode line."
  (interactive)
       ...
       (:eval
         (let* ((active (powerline-selected-window-active))
                 ...
                 (rhs (list
                        ...
                        (powerline-proj mode-line face1)
                 ...
                 (center (append (list (powerline-raw " " face1)
                                   ...
                                   ;; (powerline-tspyimt-major-mode face2 'l)
                           ...
                           (let ((evil-face (powerline-evil-face active)))
                             (if (split-string (format-mode-line minor-mode-alist))
                               ...
                               (list
                                 (powerline-raw (concat " " evil-mode-line-tag " ") evil-face)
